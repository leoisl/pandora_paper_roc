...
ROC_data_path = "/home/leandro/git/pandora1_paper/analysis_output/plot_data/ROC_data_gt_min_0.0_step_1.0_max_1000000000.0.tsv"
...
def create_interactive_visualisation():
    # load df
    ...
    app = dash.Dash("ROC_pandora", external_stylesheets=external_stylesheets)

    app.layout = html.Div([html.Div([html.H1("Pandora ROC evaluation")], style={'textAlign': "center"}),
                ...
                for coverage_threshold in coverage_checklist_values:
                    for strand_bias_threshold in strand_bias_checklist_values:
                        for gaps_threshold in gaps_checklist_values:
                            ...
                            trace_name = f"tool={tool}_coverage={dataset_coverage}_coverage_threshold={coverage_threshold}_strand_bias_threshold={strand_bias_threshold}_gaps_threshold={gaps_threshold}"
