rule make_variant_calls_probeset:
    ...
    log:
        "logs/make_variant_calls_probeset/{sample_id}_{coverage}_{tool}_coverage_filter_{coverage_threshold}_strand_bias_filter_{strand_bias_threshold}_gaps_filter_{gaps_threshold}.log"
    script:
