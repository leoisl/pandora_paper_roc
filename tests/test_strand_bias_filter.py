...
class TestStrandBiasFilter:
    def test_recordShouldBeFilteredOut_meanCoverageZeroReturnsTrue(self):
        mocked_vcf = MagicMock(coverage=0)
    ...
    def test_recordShouldBeFilteredOut_strandRatioLessThanThresholdReturnsTrue(self):
        mocked_vcf = MagicMock(coverage=100, _mean_coverage_forward=9)
        strand_bias_filter = StrandBiasFilter(0.1)
    ...
    def test_recordShouldBeFilteredOut_strandRatioEqualsThresholdReturnsFalse(self):
        mocked_vcf = MagicMock(coverage=100, _mean_coverage_forward=10)
        strand_bias_filter = StrandBiasFilter(0.1)
    ...
    def test_recordShouldBeFilteredOut_strandRatioMoreThanUpperThresholdReturnsTrue(
        ...
        mocked_vcf = MagicMock(coverage=100, _mean_coverage_forward=91)
        strand_bias_filter = StrandBiasFilter(0.1)
    ...
    def test_recordShouldBeFilteredOut_strandRatioEqualsUpperThresholdReturnsFalse(self):
        mocked_vcf = MagicMock(coverage=100, _mean_coverage_forward=90)
        strand_bias_filter = StrandBiasFilter(0.1)
    ...
    def test_recordShouldBeFilteredOut_strandRatioJustAfterThresholdReturnsFalse(self):
        mocked_vcf = MagicMock(coverage=100, _mean_coverage_forward=11)
        strand_bias_filter = StrandBiasFilter(0.1)
    ...
    def test_recordShouldBeFilteredOut_strandRatioJustBeforeUpperThresholdReturnsFalse(
        ...
        mocked_vcf = MagicMock(coverage=100, _mean_coverage_forward=89)
        strand_bias_filter = StrandBiasFilter(0.1)
