...
all_recall_reports_for_one_sample_vs_nb_samples = (
    snakemake.input.all_recall_reports_for_one_sample_vs_nb_samples
)
...
recall_report = RecallReport.from_files(all_recall_reports_for_one_sample_vs_nb_samples,
...
recall_file_for_one_sample_vs_nb_samples = recall_calculator.get_recall_vs_nb_of_samples_report(list_with_number_of_samples)


# output
recall_file_for_one_sample_vs_nb_samples.to_csv(recall_file_for_one_sample_vs_nb_samples_filename, index=False)