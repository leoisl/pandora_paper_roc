...
for sample, coverage, technology, mode in product(samples, coverages, technologies, modes):
    print(",".join([sample,
                    f"pandora_{technology}_{mode}",
                    coverage,
                    f"{base_path}/{technology}/{coverage}/random/compare_{mode}/pandora_multisample.vcf_ref.fa",
                    f"{base_path}/{technology}/{coverage}/random/compare_{mode}/pandora_multisample_genotyped.vcf"]))
