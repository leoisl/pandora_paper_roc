...
base_path="/hps/nobackup/iqbal/leandro/medaka_analysis_pipeline/processed_data"
...
for sample, reference, coverage, subsampling, technology in product(samples, references, coverages, subsamplings, technologies):
    print(",".join([sample,
                    f"medaka_{reference}",
                    coverage,
                    f"{base_path}/{technology}/{coverage}/{subsampling}/{sample}/medaka_{sample}_AND_{reference}.ref.fa",
                    f"{base_path}/{technology}/{coverage}/{subsampling}/{sample}/medaka_{sample}_AND_{reference}.vcf"]))
